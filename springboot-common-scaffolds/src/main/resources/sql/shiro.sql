...
INSERT INTO `sscs`.`sys_role`(`role_id`, `role_name`, `remark`, `create_user_id`, `create_time`) VALUES (1, '二级管理员', NULL, 1, '2021-06-25 13:48:33');
INSERT INTO `sscs`.`sys_role_menu`(`id`, `role_id`, `menu_id`) VALUES (1, 1, 1);
INSERT INTO `sscs`.`sys_user_role`(`id`, `user_id`, `role_id`) VALUES (1, 1, 1);
